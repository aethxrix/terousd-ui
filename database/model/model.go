// Package model defines the database models and data structures used by the terousd-ui panel.
package model
...
import (
	...
	"github.com/aethxrix/terousd-ui/v3/util/json_util"
	"github.com/aethxrix/terousd-ui/v3/xray"
)
...
// User represents a user account in the terousd-ui panel.
type User struct {
...
// Setting stores key-value configuration settings for the terousd-ui panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote terousd-ui panel registered with the central panel.
