// Package main is the entry point for the terousd-ui web panel application.
...
import (
	...
	"github.com/aethxrix/terousd-ui/v3/database"
	"github.com/aethxrix/terousd-ui/v3/logger"
	"github.com/aethxrix/terousd-ui/v3/sub"
	"github.com/aethxrix/terousd-ui/v3/util/crypto"
	"github.com/aethxrix/terousd-ui/v3/util/sys"
	"github.com/aethxrix/terousd-ui/v3/web"
	"github.com/aethxrix/terousd-ui/v3/web/global"
...
// runWebServer initializes and starts the web server for the terousd-ui panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the terousd-ui panel.
func migrateDb() {
...
// main is the entry point of the terousd-ui application.
