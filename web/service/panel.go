...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/aethxrix/terousd-ui/main/update.sh"
...
// GetUpdateInfo checks GitHub for the latest terousd-ui release.
...
func downloadPanelUpdater() (string, error) {
	...
	file, err := os.CreateTemp("", "terousd-ui-update-*.sh")
	if err != nil {
		return "", err
	}
	path := file.Name()
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/aethxrix/terousd-ui/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()
