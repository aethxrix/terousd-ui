...
export default function IndexPage() {
  ...
  function openPanelVersion() {
    if (panelUpdateInfo.updateAvailable) {
      ...
      window.open('https://github.com/aethxrix/terousd-ui/releases', '_blank', 'noopener,noreferrer');
    }
  }

  function openRepository() {
    window.open('https://github.com/aethxrix/terousd-ui', '_blank', 'noopener,noreferrer');
  }
                ...
                <Row gutter={[isMobile ? 8 : 16, 12]}>
                  ...
                  <Col xs={24} lg={12}>
                    <Card
                      ...
                      hoverable
                      actions={[
                        <Space className="action" key="repo" onClick={openRepository}>
                          <GithubOutlined />
                          {!isMobile && <span>Terousd</span>}
                        </Space>,
                        <Space
                          key="panel-version"
