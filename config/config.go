// Package config provides configuration management utilities for the terousd-ui panel,
...
// GetVersion returns the version string of the terousd-ui application.
func GetVersion() string {
	return strings.TrimSpace(version)
}

// GetName returns the name of the terousd-ui application.
func GetName() string {
