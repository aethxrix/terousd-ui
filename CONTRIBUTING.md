...
Thanks for taking the time to contribute to terousd-ui. This guide gets a development panel running locally and explains the conventions the project follows so changes land cleanly.
...
```bash
git clone https://github.com/aethxrix/terousd-ui.git
cd terousd-ui
...
- Bug reports and feature requests: [GitHub Issues](https://github.com/aethxrix/terousd-ui/issues)
- General questions and ideas: [GitHub Discussions](https://github.com/aethxrix/terousd-ui/discussions)
